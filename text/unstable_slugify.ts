 ...
 * @example Usage
 * ```ts
 * import { NON_WORD, slugify } from "unstable_slugify.ts";
 ...
 * @example Usage
 * ```ts
 * import { DIACRITICS, slugify } from "unstable_slugify.ts";
 * import { assertEquals } from "../assert/mod.ts";
 ...
 * @example Usage
 * ```ts
 * import { ASCII_DIACRITICS, slugify } from "unstable_slugify.ts";
 * import { assertEquals } from "../assert/mod.ts";
 ...
 * @example Usage
 * ```ts
 * import { NON_ASCII, slugify } from "unstable_slugify.ts";
 * import { assertEquals } from "../assert/mod.ts";
