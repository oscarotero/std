 ...
 * ```ts
 * import { isErrorStatus } from "status.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { isStatus } from "status.ts";
 ...
 * @example Usage
 * ```ts
 * import { isInformationalStatus } from "status.ts";
 * import { assert } from "../assert/mod.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { isSuccessfulStatus } from "status.ts";
 * import { assert } from "../assert/mod.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { isClientErrorStatus } from "status.ts";
 * import { assert } from "../assert/mod.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { isServerErrorStatus } from "status.ts";
 * import { assert } from "../assert/mod.ts";
 *
