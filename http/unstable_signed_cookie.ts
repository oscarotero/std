 ...
 * @example Usage
 * ```ts ignore no-assert
 * import { signCookie } from "unstable_signed_cookie.ts";
 ...
 * @example Usage
 * ```ts ignore no-assert
 * import { verifySignedCookie } from "unstable_signed_cookie.ts";
 ...
 * @example Usage
 * ```ts ignore no-assert
 * import { verifySignedCookie, parseSignedCookie } from "unstable_signed_cookie.ts";
 * import { getCookies } from "cookie.ts";
 *
 * const key = await crypto.subtle.generateKey(
 *   { name: "HMAC", hash: "SHA-256" },
