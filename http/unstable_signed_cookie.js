 ...
 * @example Usage
 * ```ts ignore no-assert
 * import { signCookie } from "unstable_signed_cookie.js";
 ...
 * @example Usage
 * ```ts ignore no-assert
 * import { verifySignedCookie } from "unstable_signed_cookie.js";
 ...
 * @example Usage
 * ```ts ignore no-assert
 * import { verifySignedCookie, parseSignedCookie } from "unstable_signed_cookie.js";
 * import { getCookies } from "cookie.js";
 *
 * const key = await crypto.subtle.generateKey(
 *   { name: "HMAC", hash: "SHA-256" },
