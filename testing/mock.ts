 ...
 * @example Usage
 * ```ts
 * import { MockError, spy } from "mock.ts";
 ...
 * @example Usage
 * ```ts
 * import { mockSession, restore, stub } from "mock.ts";
 ...
 * @example Usage
 * ```ts
 * import { mockSessionAsync, restore, stub } from "mock.ts";
 * import { assertEquals, assertNotEquals } from "../assert/mod.ts";
 *
 * const setTimeout = globalThis.setTimeout;
 ...
 * @example Usage
 * ```ts
 * import { stub, assertSpyCalls } from "mock.ts";
 *
 * const obj = {
 *   method() {
 ...
 * @example Usage
 * ```ts
 * import { assertSpyCall, spy } from "mock.ts";
 *
 * const func = spy((a: number, b: number) => a + b);
 *
 * func(3, 4);
 ...
 * @example Usage
 * ```ts
 * import { assertSpyCallAsync, spy } from "mock.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { assertSpyCallArg, spy } from "mock.ts";
 *
 * const func = spy((a: number, b: number) => a + b);
 *
 * func(3, 4);
 ...
 * @example Usage
 * ```ts
 * import { returnsThis } from "mock.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { returnsArg } from "mock.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { returnsArgs } from "mock.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 ...
 * @example Usage
 * ```ts
 * import { returnsNext } from "mock.ts";
 ...
 * @example Usage
 * ```ts
 * import { resolvesNext } from "mock.ts";
