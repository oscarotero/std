 ...
 * @example Usage
 * ```ts
 * import { describe, test } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * describe("example", () => {
 *   test("should pass", () => {
 ...
 * @example Usage
 * ```ts
 * import { describe, it, beforeAll } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * beforeAll(() => {
 ...
 * @example Usage
 * ```ts
 * import { describe, it, before } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * before(() => {
 *  console.log("before");
 ...
 * @example Usage
 * ```ts
 * import { describe, it, afterAll } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * afterAll(() => {
 ...
 * @example Usage
 * ```ts
 * import { describe, it, after } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * after(() => {
 *  console.log("after");
 ...
 * @example Usage
 * ```ts
 * import { describe, it, beforeEach } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * beforeEach(() => {
 ...
 * @example Usage
 * ```ts
 * import { describe, it, afterEach } from "bdd.ts";
 * import { assertEquals } from "../assert/mod.ts";
 *
 * afterEach(() => {
