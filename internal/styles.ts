 ...
 * @example Usage
 * ```ts no-assert
 * import { brightBlack } from "styles.ts";
 *
 ...
 * @example Usage
 * ```ts no-assert
 * import { red, stripAnsiCode } from "styles.ts";
 *
